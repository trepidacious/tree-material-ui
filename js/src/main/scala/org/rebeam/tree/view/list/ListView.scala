...
//                                         toItem: A => F,
//                                         itemToKey: A => js.Any,
//                                         itemView: GenericComponent //ReqProps[Cursor[A, Pages[C, P]], Unit, Unit, TopNode],
//                                         subheader: String,
...
//              MuiSubheader(inset = true, style = js.Dynamic.literal("height" -> "60px", "padding-top" -> "8px"))(subheader: VdomNode)
